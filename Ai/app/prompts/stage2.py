...
2. history가 있으면 context_keywords와 connection_keyword를 누적 반영하여 추천 방향을 심화.
3. history의 step이 클수록 더 구체적이고 좁은 맥락으로 추천을 좁혀라.
4. exclude_domains에 포함된 도메인은 recommendations에서 완전히 생략.
5. 각 도메인별 추천은 반드시 서로 다른 제목으로 4개. 같은 제목 두 번 사용 절대 금지. exclude_domains에 해당하면 해당 키 자체를 제거.
6. 추천 콘텐츠는 실제 존재하는 작품만. 없는 제목 창작 금지.
7. connection_keyword는 이 추천 콘텐츠와 현재 콘텐츠를 잇는 핵심 단어 1개.
8. map_title은 history 배열이 1개 이상일 때만 생성. 비어있으면 map_title 필드 자체를 생략.
9. reason은 반드시 50자 이내로 작성한다.
10. 각 도메인별 4개의 추천시 입력한 도메인 빼고 4개.
11. 각 도메인 배열의 길이는 반드시 4
...
[출력 스키마]
{
  "recommendations": {
    "film": [
      {"title1": "작품명1", "reason": "", "tags": [""], "connection_keyword": ""},
      {"title2": "작품명2", "reason": "", "tags": [""], "connection_keyword": ""},
      {"title3": "작품명3", "reason": "", "tags": [""], "connection_keyword": ""},
      {"title4": "작품명4", "reason": "", "tags": [""], "connection_keyword": ""}
    ],
    "book": [{"title": "", "reason": "", "tags": [""], "connection_keyword": ""}],
    "music": [{"title": "", "reason": "", "tags": [""], "connection_keyword": ""}]
  },
  "map_title": ""
}"""