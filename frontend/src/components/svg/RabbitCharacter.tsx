    ...
    <Svg width={size} height={size} viewBox="0 0 260 260">
      <Defs>
        ...
        <RadialGradient id="bodyGrad" cx="45%" cy="40%" r="60%">
          <Stop offset="0%" stopColor={Colors.accent.aurora} stopOpacity="1" />
          <Stop offset="50%" stopColor={Colors.accent.pulsar} stopOpacity="1" />
          <Stop offset="100%" stopColor={Colors.accent.nebulaRose} stopOpacity="1" />
        </RadialGradient>
        {/* 귀 그라디언트 */}
        ...
        <RadialGradient id="glowGrad" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor={Colors.accent.pulsar} stopOpacity="0.4" />
          <Stop offset="100%" stopColor={Colors.accent.pulsar} stopOpacity="0" />
        </RadialGradient>
        {/* 치마 그라디언트 */}
        <RadialGradient id="skirtGrad" cx="50%" cy="20%" r="70%">
          <Stop offset="0%" stopColor={Colors.accent.aurora} stopOpacity="0.9" />
          <Stop offset="100%" stopColor={Colors.semantic.danger} stopOpacity="0.8" />
        </RadialGradient>
      </Defs>
      ...
      {/* 볼 (왼) */}
      <Ellipse cx="102" cy="118" rx="14" ry="10" fill={Colors.semantic.danger} opacity="0.6" />
      {/* 볼 (오) */}
      <Ellipse cx="158" cy="118" rx="14" ry="10" fill={Colors.semantic.danger} opacity="0.6" />
      ...
      {/* 눈동자 (왼) */}
      <Circle cx="115" cy="109" r="5" fill={Colors.background.nebulaBase} />
      {/* 눈동자 (오) */}
      <Circle cx="147" cy="109" r="5" fill={Colors.background.nebulaBase} />
